  ...
  return (
    <>
      <main className="mx-auto my-0 max-w-[800px] p-10">
        ...
        <h2 className="mb-5 text-step--2 font-bold">Last updated: 14/12/23</h2>
        <p className="mb-5 text-step--3">
          Welcome to MixieCooking, your trusted platform for culinary
          exploration and collaboration. At MixieCooking, we prioritize your
          privacy and data security. This Privacy Policy outlines our commitment
          to safeguarding your personal information, detailing how we collect,
          use, protect, and share your data.
        </p>
        <p>
          By using MixieCooking, you consent to the practices described in this
        ...
        <ol className="mb-5 list-decimal pl-5">
          <li className="mb-5 text-step--3">
            ...
            <p className="mb-5 text-step--3">
              ...
              <p>
                ...
                enhance your MixieCooking experience, including:
              </p>
              <br />
              <ul>
                <li>Site theme</li>
          ...
          <li className="mb-5 text-step--3">
            Consent
            <p className="mb-3 text-step--3">
              By using MixieCooking, you consent to the collection and use of
