      ...
      <article>
        <section>
          ...
          <p>
            ...
            website or using any other services provided by MixieCooking.
          </p>
        ...
        <ol className="mb-5 list-decimal pl-5">
          ...
          <li className="mb-5 text-step--3">
            ...
            <section>
              ...
              links to third party websites for which MixieCooking may receive
              ...
              leaving a MixieCooking Property and visiting a website that is not{" "}
            </section>
          </li>
          <li className="mb-5 text-step--3">
            Third-Party Links
