...
export default function RecipeSEO({ recipeDescription, recipeName, imageUrl, info, recipeUrl, createdAt, keywords}: seo) {
    return (
        <Head>
            ...
            <meta property="fb:app_id" content="668390526646215" /> {/*TODO: change latter */}
            <meta property="article:published_time" content={createdAt.toString()} />
            <meta name="keywords" content={keywords?.toString()} />


            <meta name="twitter:site" content="@meally" /> {/*TODO: change when twitter account is up */}
            <meta name="twitter:creator" content="@meally" /> {/*TODO: change when twitter account is up */}
